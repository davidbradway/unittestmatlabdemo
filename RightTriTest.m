...
classdef RightTriTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test306090Triangle(testCase)
            ...
            % Best procedure
            % See notes on tolerance here [http://www.mathworks.com/help/matlab/ref/matlab.unittest.qualifications.verifiable.verifyequal.html]
            testCase.verifyEqual(actSolution1,expSolution1, 'AbsTol', tol)
            testCase.verifyEqual(actSolution2,expSolution2, 'AbsTol', tol)
        end
    end
end